...
describe('Tests for socialblade-com-api', () => {
  ...
  it('should convert an array to object', () => {
    ...
    assert.strictEqual(tableConvertedArray[0].date, '4/27/2020')
    ...
    assert.strictEqual(tableConvertedArray[1].date, '4/28/2020')
    ...
    assert.strictEqual(tableConvertedArray[2].date, '4/29/2020')
    ...
    assert.strictEqual(chartsConvertedArray[0].data[0].date, '6/21/2016')
    ...
    assert.strictEqual(chartsConvertedArray[1].data[0].date, '6/21/2016')
